...
from apps.service.models import ServiceClient, SubcontractADV, SubcontractAll
from .models import Client, Contract
from .forms import (AddAdvService, AddSubPeople, ClientNew, EmployeeDesignNew, EmployeeDevNew, NewServiceClient, AddContract, UpdServiceClient)
